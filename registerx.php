          ...
          <form action="#">
			...
			<div class="col-12 col-md-6">
              ...
              <select class="form-control" id="state">
						  <option value="<?php if(isset($_SESSION['state_reg'])){ echo $_SESSION['state_reg']; }else{ echo ''; } ?>" selected="selected"><?php if(isset($_SESSION['state_reg'])){ echo $_SESSION['state_reg']; }else{ echo 'Select State*'; } ?></option>
