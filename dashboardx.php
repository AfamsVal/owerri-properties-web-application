...
<head>
    ...
    <!-- ** Basic Page Needs ** -->
    <meta charset="utf-8">
    <title>Owerriproperty - Dashboard</title>
                ...
                <div class="col-lg-4">
                    <div class="sidebar">
                        ...
                        <div class="widget user-dashboard-menu">
                            <ul>
                                <li class="active"><a href="dashboard-my-ads.php"><i class="fa fa-user"></i> My Ads</a>
                                </li>
                                <li><a href="dashboard-favourite-ads.php"><i class="fa fa-bookmark-o"></i> Favourite Ads
                                        <span>5</span></a></li>
                                <li><a href="dashboard-archived-ads.php"><i class="fa fa-file-archive-o"></i>Archived
                                        Ads
                                        <span>12</span></a></li>
                                <li><a href="dashboard-pending-ads.php"><i class="fa fa-bolt"></i> Pending
                                        Approval<span>23</span></a>
                                </li>
                                <li><a href="indexx.php"><i class="fa fa-cog"></i> Logout</a></li>
                                            ...
                                            <ul class="list-inline justify-content-center">
                                                ...
                                                <li class="list-inline-item">
                                                    <a class="edit" data-toggle="tooltip" data-placement="top"
                                                        title="Edit" href="dashboard.php">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a class="delete" data-toggle="tooltip" data-placement="top"
                                                        title="Delete" href="dashboard.php">
                                ...
                                <tr>
                                    ...
                                    <td class="action" data-title="Action">
                                        <div class="">
                                            <ul class="list-inline justify-content-center">
                                                <li class="list-inline-item">
                                                    <a href="category.php" data-toggle="tooltip" data-placement="top"
